...
namespace RayFireEditor
{
        ...
        public class RFUvRegionEditor : EditorWindow
    {
        ...
        private void OnGUI()
        {
            ...
            // Draw labels
            Handles.Label (new Vector3 (0 + 4, position.height - 12, 0), "(0, 0)");
            Handles.Label (new Vector3 (position.width - 33, 0 + 10,  0), "(1, 1)");
        ...
        private void HandleResize()
        {
            for (int i = 0; i < resizeHandles.Length; i++)
            {
                ...
                var fmh_169_73_638973469252229395 = Quaternion.identity; Vector3 newHandlePosition = Handles.FreeMoveHandle(pos, 10f, Vector2.zero, Handles.RectangleHandleCap);
